                  ...
                  <tr key={p.idPedido} className="hover:bg-surface-container-lowest transition-colors h-12">
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex justify-end gap-1">
                        ...
                        }} className="p-2 text-on-surface-variant hover:bg-surface-container-low rounded transition-colors" title="Ver detalle">
                          <span className="material-symbols-outlined text-xl">visibility</span>
                        </button>
                        <button onClick={() => enviarWhatsApp(p)} className="p-2 text-[#25D366] hover:bg-[#25D366]/10 rounded transition-colors" title="Enviar por WhatsApp">
