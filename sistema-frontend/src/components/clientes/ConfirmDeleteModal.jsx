function ConfirmDeleteModal({ visible, onClose, onConfirmar, nombreCliente }) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6 modal-overlay">
      <div className="bg-white w-full max-w-md rounded-xl shadow-2xl p-4 sm:p-6 text-center">
        ...
        <h3 className="text-xl font-bold text-on-surface">¿Eliminar cliente?</h3>
        <p className="text-base text-on-surface-variant mt-2 mb-2">
          Esta acción es permanente. Se eliminará el cliente <strong>{nombreCliente}</strong> del sistema.
        </p>
